 ...
 */
package co.aoscp.miservices.micode;

public class MiBits {

    public static final String AMBIENT_KEY = "e49c241cdaa4257f" + "d4607ef93aa9ca7d";
	public static final String AMBIENT_SECRET = "TomUVHpZeWvtH2JIUqEXhdp" + "DyY8bizyS6AGJ8Rds";
}
